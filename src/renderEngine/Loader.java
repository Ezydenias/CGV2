...
public class Loader {
    ...
    public RawModel loadToVAO(double[] positions,double[] textureCoordinates,double[] normals, int[] indices){
        int vaoID = createVAE();
    ...
    private void storeDataInAttributeList(int attributeNumber,int coordinateSize, double[] data){
        ...
        GL20.glVertexAttribPointer(attributeNumber,coordinateSize, GL11.GL_DOUBLE,false,0,0);
